...
r_f = 200  # مقاومت میدان (اهم)
r_adj = 120  # مقاومت قابل تنظیم (اهم)
r_a = 0.19  # مقاومت آرماچر + مقاومت سری (اهم)
i_l = np.arange(0, 101, 2)  # جریان‌های خط (آمپر)
...
plt.title(r'$\bf{Cumulatively\ Compounded\ DC\ Motor\ Torque-Speed\ Characteristic}$', fontsize=14, weight='bold')
plt.axis([0, 200, 900, 1600])
plt.grid(True)
plt.show()
