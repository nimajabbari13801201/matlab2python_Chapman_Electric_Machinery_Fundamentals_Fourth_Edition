# همانطور که در بالا گفته شد، در این کد، ویژگی‌های ترمینال ژنراتور با در نظر گرفتن اثرات واکنش آرماچر محاسبه می‌شود.
import numpy as np
import matplotlib.pyplot as plt

# بارگذاری داده‌ها
data = np.loadtxt('p97_mag.dat')
if_values = data[:, 0]  # جریان میدان
ea_values = data[:, 1]  # ولتاژ داخلی تولید شده

n_0 = 1800  # سرعت ژنراتور
...
i_a = np.arange(0, 51, 1)  # جریان‌های آرماچر
...
plt.title(r'$\bf{Terminal\ Characteristic\ of\ a\ Cumulatively\ Compounded\ DC\ Generator}$', fontsize=14, weight='bold')
